...
public class ApiClient {
    ...
    private String basePath = "https://delivery-p{programId}-e{environmentId}.adobeaemcloud.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://delivery-p{programId}-e{environmentId}.adobeaemcloud.com
