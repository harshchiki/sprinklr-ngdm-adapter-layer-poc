...
public class ActivatedAssetsSearchApi {
    private ApiClient apiClient;

    public ActivatedAssetsSearchApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ActivatedAssetsSearchApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call searchCall(SearchRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/adobe/assets/search";
    ...
    /**
     * Search for activated assets based on specified criteria (asynchronously)
     * Search Activated Assets
     * @param body  (required)
